...
**Related Types:**
- `ConnectionConfig`: Connection configuration, see [Connection Configuration Documentation](3.1SDK_Connection.md)
- `TransportProtocol`: Transport protocol type, see [Connection Configuration Documentation](3.1SDK_Connection.md)
...
**Return Value:**  
`ConnectionState` enumeration value, see [Connection State Documentation](3.1SDK_Connection.md)
...
See [Callback Reference](3.4SDK_Callback.md) for `IControlCallback` class description.
...
**Related Documentation:**  
See [Callback Reference](3.4SDK_Callback.md) for `IDataCallback` class description.
...
**Description:**  
Take control of the robot. If the APP is currently in control, you cannot forcibly take over.See [sdk_control_ownership](3.5SDK_Control_Ownership.md)
